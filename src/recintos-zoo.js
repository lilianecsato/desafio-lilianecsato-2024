class RecintosZoo {
    ...
    analisaRecintos(animal, quantidade) {
        ...
        if (animal === "LEOPARDO") {
            return "não há recinto viável"; // O Leopardo só pode ir para a savana. A savana do recinto 1 já tem 3 macacos e a savana do recinto 5 tem 1 leão.
        }
        ...
        if (animal === "HIPOPOTAMO") {
            ...
            if (quantidade <= (7 - 2)) { // Recinto 3 (bioma "savana e rio") tem 7 unidades de espaço, 2 ocupadas por uma gazela.
                return "Recinto 1 (espaço livre: " + (10 - 3 - 1 - quantidade) + " total: 10)" +
                    " Recinto 3 (espaço livre: " + (7 - 2 - 1 - quantidade) + " total: 7)" +
                    " Recinto 4 (espaço livre: " + (8 - quantidade) + " total: 8)";
            } else if (quantidade <= 8) { // Recinto 4 (bioma "rio") tem 8 unidades de espaço e está vazio
                return "Recinto 4 (espaço livre: " + (8 - quantidade) + " total: 8)";
            } else {
                return "não há recinto viável";
            }
